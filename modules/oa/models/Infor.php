...
/**
 * This is the model class for table "{{%oa_infor}}".
 *
 * @property int $id
 ...
 * @property string $zstart 展示开始日期
 * @property string $zsend 展示截止日期
 */
class Infor extends \yii\db\ActiveRecord
{
    const FIELD_DETAIL = [
        ...
        'zstart' => ['type' => 'string', 'filter' => 'like'],
        'zsend' => ['type' => 'string', 'filter' => 'like'],
    ];
    ...
    {
        return [
            [['optdt', 'enddt', 'startdt', 'indate', 'zstart', 'zsend'], 'safe'],
            [['content'], 'string'],
